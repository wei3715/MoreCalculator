...
#import "JLBusinessView.h"
#import "JLAccumulationView.h"
#import "JLCombinationView.h"
#import "JLHouseInterestRatetVC.h"
#import "JLPickerview.h"
#import "JLHouseLoansModel.h"

@interface JLHomeCalculatorVC ()<UIGestureRecognizerDelegate,UITextFieldDelegate>
@property (nonatomic ,strong)JLBusinessView *busiView;//商业贷款的View
@property (nonatomic ,strong)JLAccumulationView *accView;//公积金贷款的View
@property (nonatomic ,strong)JLCombinationView *comView;//组合贷款的View
...
@implementation JLHomeCalculatorVC
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //把颜色转成图片
    UIImage *image = [UIImage imageWithColor:mainBarColor WithAlpha:1];
    //把图片设置为背景
...
- (void)viewDidLoad
{
    ...
    //公积金贷款的View
    _accView = [[JLAccumulationView alloc]initWithFrame:CGRectMake(0, 80*BOScreenH/1334, BOScreenW, BOScreenH)];
    ...
    //组合贷款的View
    _comView = [[JLCombinationView alloc]initWithFrame:CGRectMake(0, 80*BOScreenH/1334, BOScreenW, BOScreenH)];
    ...
    //商业贷款的View
    _busiView = [[JLBusinessView alloc]initWithFrame:CGRectMake(0, 80*BOScreenH/1334, BOScreenW, BOScreenH)];
...
{
    JLHouseInterestRatetVC *lateVc = [[JLHouseInterestRatetVC alloc]init];
...
- (void)fangdaijiekou
{
    ...
    [manager POST:[NSString stringWithFormat:@"%@Common/jisuanqiFangdai",BASEURL] parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        {
            JLHouseLoansModel *model = [JLHouseLoansModel mj_objectWithKeyValues:responseObject[@"data"]];
