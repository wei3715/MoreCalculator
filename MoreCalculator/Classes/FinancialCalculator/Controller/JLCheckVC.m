...
#import "JLCheckVC.h"
#import "JLCheckCell.h"

@interface JLCheckVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic ,strong)UIView *zeroView;//第零区的view
@property (nonatomic ,strong)UIView *firstView;//第一区的view

@end

@implementation JLCheckVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JLCheckCell *cell = [tableView dequeueReusableCellWithIdentifier:cellString];
    if (cell == nil)
    {
        cell = [[JLCheckCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellString];
    }
    //根据不同的区改变背景图片
    if (indexPath.row%2)
    {
