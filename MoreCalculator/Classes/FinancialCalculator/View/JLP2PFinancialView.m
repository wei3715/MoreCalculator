...
@implementation JLP2PFinancialView
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        [_lookButton setTitleColor:mainBarColor forState:UIControlStateNormal];
        ...
        _monthSegmentCon.tintColor = mainBarColor;
        ...
        _yearSegmentCon.tintColor = mainBarColor;
        ...
        for (int i = 0; i < 3; i ++)
        {
            ...
            threelineView.backgroundColor = mainBarColor;
