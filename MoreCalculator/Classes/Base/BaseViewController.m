...
{
    [self.navigationController.navigationBar setBarTintColor:mainBarColor];
...
{
    //把颜色转成图片
    UIImage *image = [UIImage imageWithColor:[UIColor colorWithHexString:@"#F88656" alpha:1] WithAlpha:1];
    //把图片设置为背景
