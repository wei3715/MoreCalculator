...
#import "JLCarLoansModel.h"

@interface JLCarCalculatorVC ()<UIGestureRecognizerDelegate,UITextFieldDelegate>
...
@implementation JLCarCalculatorVC
...
- (void)viewDidLoad
{
    ...
    [pointButton setTitle:@"开始计算" forState:UIControlStateNormal];
    ...
    pointButton.layer.cornerRadius = 40*BOScreenH/1334;
    if (iPhone6P)
    {
...
- (void)CarLoansData
{
    ...
    [manager POST:[NSString stringWithFormat:@"%@Common/jisuanqiChedai",BASEURL] parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        {
            JLCarLoansModel *model = [JLCarLoansModel mj_objectWithKeyValues:responseObject[@"data"]];
